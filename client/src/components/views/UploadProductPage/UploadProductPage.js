    ...
    return (
        ...
        <div style = {{maxWidth: '700px', margin: '2rem auto'}}>
            ...
            <Form onSubmit={submitHandler}>
                ...
                <br />
                <label>주요 판매제품</label>
                <select onChange={productChangeHandler} value={Product} style={{
                            width: 700, height: 50, border: '1px solid lightgray',
                ...
                <br />
                <label>추구하는 가치</label>
                <select onChange={ecoChangeHandler} value={Eco} style={{
                            width: 700, height: 50, border: '1px solid lightgray',
                            display: 'flex', alignItems: 'center', justifyContent: 'center'
                        }} >
                        {Ecos.map(item => (
